	...
	experience: [
		...
		},
		{
			...
			bullet_points: [
				...
				"Conducted threat modeling on 8 core features, bringing all production code to medium risk or lower.",
				"Led security reviews on 8 projects, fixed all high/critical pen test findings, and trained 250+ employees on security best practices.",
				"Improved template discoverability with new dialog and entry points, driving increased adoption.",
				"Implemented 4 API endpoints to enable groups integration for 150 enterprise customers.",
			],
			logo: "https://cdn.jsdelivr.net/npm/programming-languages-logos/src/javascript/javascript.png",
		},
		{
		...
		},
		{
			...
			bullet_points: [
				...
				"Built automated integration test framework using Docker and Fabric8, increasing integration test coverage by 50%.",
